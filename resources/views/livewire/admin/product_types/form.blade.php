<div class="d-flex align-items-center justify-content-between gap-3 mb-3">
    <div class="main-title mb-0">
        ...
        <div class="large">{{ $obj ? __('Edit') : __('Add') }} @lang('admin.type')</div>
    </div>
    <button class="main-btn btn-main-color" wire:click='$set("screen","index")'>عرض كل الانواع</button>
</div>
<div class="row g-3">
        ...
        @else
            @if ($obj && $obj->image)
                <img src="{{ display_file($obj->image) }}" alt="" class="img-thumbnail img-preview"
                    width="60px">
            @else
                <img src="{{asset('admin-asset/img/image-preview.webp')}}" alt="" class="img-thumbnail img-preview"
                    width="60px">
            @endif
        @endif
