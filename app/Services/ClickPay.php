...
class ClickPay extends BaseController implements PaymentInterface
{
    ...
    public function __construct($route='clickpay.callback')
    {
        $this->clickpay_server_key =setting('clickpay_server_key');
        $this->clickpay_profile_id = setting('clickpay_profile_id');
        $this->verify_route_name = $route;
    }
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null): array
    {
        ...
        $response = \Http::withHeaders([
            ...
            "return" => route($this->verify_route_name,['payment'=>"clickpay",'payment_id'=>$uniqid]),
            "framed" => false,
            "framed_return_top" => false,
            "framed_return_parent" => false,
            "hide_shipping" => true
